				...
				<section className="banner">
					...
					<div className="banner-content">
						...
						<div className="banner-subtitle">
							<p>
								Uma plataforma que <strong>conecta</strong> Psicólogos e Educadores
								Sociais com um líder Comunitário para prestação de serviço voluntário às
				...
				<section id="registro-processo">
					<div className="proceso-voluntariado">
						...
						<div className="proceso-texto">
							...
							<p>
								complete o <Link href="./JoinUs">formulário</Link> de inscrição com seus
						...
						<div className="proceso-texto">
							...
							<p>
								o Lider do refugiado que precise da sua ajuda entrará em contato, e você
								será designado para uma área específica, com base na suas habilidades e
								disponibilidade.
							</p>
						</div>
					...
					<div className="proceso-voluntariado liderança">
						...
						<div className="proceso-texto-liderança">
							...
							<p>
								...
								voluntários disponíveis para atendimento dos seus refugiados
							</p>
						</div>
						<div className="proceso-texto-liderança">
