...
// 			} else {
// 				setError(
// 					`Error al enviar datos: ${error.response?.data?.message || error.message}`,
// 				);
// 			}
// 		}
// 		setIsLoading(false);
...
// 									responsabilidade como psicólogo voluntário, conforme explicado no{" "}
// 									<Link href="../../termo-psicologo" target="_blank">
// 										Termo de Responsabilidade
// 									</Link>
// 									. Eu confirmo que li e aceito as condições de atuação voluntária, a
// 									confidencialidade, a pontualidade e a conformidade com o CRP, e estou
// 									ciente de que a plataforma atua apenas como um divulgador de
