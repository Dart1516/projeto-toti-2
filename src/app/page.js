          ...
          <main className="main">
            <div className="text-home">
              <div className="text-container">
                ...
                <p>
                  Conectando voluntários e instituições para fortalecer o Rio
                  Grande do Sul. Visando oferecer ajuda prática e esperança
                  àqueles afetados pelas inundações no RS, disponibilizando
                  serviços com psicólogos e educadores sociais.
                </p>
                {/* <p>
            ...
            <div className="card-item">
              ...
              <div className="card-text">
                ...
                <p>
                  ...
                  ferramentas para lidar com traumas, fornecerá suporte
              ...
              <div className="processos">
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    <h3>Registro</h3>
                    <p>
                      Preencha o <Link href={'/servicos'}>formulário</Link> com
                ...
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    ...
                    <p>
                      Iram ao banco de dados que estará disponível para os
                      lideres dos refugiados, que necessitam da ajuda de você.
                    </p>
                  </div>
                </div>
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    ...
                    <p>
                      ...
                      contato, e você será designado para uma área específica,
                      com base na suas habilidades e disponibilidade.
                    </p>
                  </div>
                </div>
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    ...
                    <p>
                      Comece a oferecer seu apoio às comunidades afetadas. O
                      líder fornecerá os detalhes do serviço.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="processos">
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    <h3>Registro</h3>
                    <p>
                      Preencha o <Link href={'/servicos'}>formulário</Link> de
                ...
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    <h3>Depois do cadastro</h3>
                    <p>
                      Com o email e a senha que você cadastrou, terá acesso a
                      lista dos voluntarios disponíveis para atendimento dos
                      seus refugiados.
                    </p>
                  </div>
                </div>
                <div className="processo">
                  ...
                  <div className="texto-processo">
                    <h3>Depois do contato</h3>
                    <p>
                      Será disponibilizado telefone e email do voluntario para
                      você entrar en contato e receber a ajuda que necessitam o
          ...
          <div className="pergunta">
            ...
            <div className={`resposta ${activeIndices[0] ? 'show' : ''}`}>
              <p>
                ...
                Comunitário para prestação de serviço voluntário.
              </p>
            </div>
          </div>
          <div className="pergunta">
            ...
            <div className={`resposta ${activeIndices[1] ? 'show' : ''}`}>
              <p>
                ...
                preencher um formulário com suas informações e interesses. Assim
                que recebermos a demanda dos solicitantes O Líder Comunitário
                entrará em contato para discutir como você pode contribuir.
              </p>
            </div>
          </div>
          <div className="pergunta">
            ...
            <div className={`resposta ${activeIndices[2] ? 'show' : ''}`}>
              <p>
                ...
                que buscam diferentes tipos de apoio das ONGs. Ele desempenha um
                papel fundamental na comunidade, agindo como um elo entre as
                organizações e os indivíduos que necessitam de assistência,
                garantindo que os recursos e serviços sejam acessíveis e
                eficazmente distribuídos. Além disso, o líder comunitário
                trabalha para fortalecer a coesão social e promover o
          ...
          <div className="pergunta">
            ...
            <div className={`resposta ${activeIndices[3] ? 'show' : ''}`}>
              <p>
                ...
                grupos. Nosso objetivo é aumentar as áreas de atuação para que
                mais voluntários possam se juntar.
              </p>
            </div>
          </div>
          <div className="pergunta">
            ...
            <div className={`resposta ${activeIndices[4] ? 'show' : ''}`}>
              <p>
                ...
                vida de pessoas em um momento de fragilidade, além de
                desenvolver novas habilidades, expandir sua rede de contatos,
                profissional e pessoal, e contribuir para uma causa
                significativa.
              </p>
            </div>
          </div>
