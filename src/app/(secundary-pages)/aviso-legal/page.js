      ...
      <div className="container-body">
        <div className="aviso-legal">
          ...
          <div className="legal-content">
            ...
            <p>
              No âmbito de nosso site de voluntariado, coletamos e tratamos os
            ...
            <p>
              Os dados pessoais coletados serão utilizados exclusivamente para
              os seguintes fins:
            </p>
            <ul>
              ...
              <li>
                Prestação de serviços de apoio às pessoas afetadas pela
                inundação no Rio Grande do Sul
              </li>
              <li>
                Avaliação da eficácia das intervenções e melhoria dos serviços
                prestados
              </li>
            </ul>
            ...
            <p>
              O tratamento dos dados pessoais é baseado no consentimento
              explícito dos interessados, que fornecem seus dados de forma
              voluntária através do formulário disponível em nosso site.
            </p>
            ...
            <ul>
              ...
              <li>
                Solicitar a limitação do tratamento de seus dados pessoais
              </li>
            ...
            <p>
              Reservamo-nos o direito de atualizar este Aviso Legal de Proteção
              de Dados periodicamente. Recomendamos que os voluntários revisem
              este aviso regularmente para se manterem informados sobre como
