			...
			<div className={styles3["container-body"]}>
				<div className={styles3["aviso-legal"]}>
					...
					<div className={styles3["legal-content"]}>
						...
						<p>
							Os dados pessoais coletados serão utilizados exclusivamente para os
							seguintes fins:
						</p>
						<ul>
							...
							<li>
								Prestação de serviços de apoio às pessoas afetadas pela inundação no Rio
								Grande do Sul
							</li>
							<li>
								Avaliação da eficácia das intervenções e melhoria dos serviços prestados
							</li>
						</ul>

						<h3>4. Base Legal para o Tratamento de Dados</h3>
						<p>
							O tratamento dos dados pessoais é baseado no consentimento explícito dos
							interessados, que fornecem seus dados de forma voluntária através do
						...
						<p>
							Reservamo-nos o direito de atualizar este Aviso Legal de Proteção de
							Dados periodicamente. Recomendamos que os voluntários revisem este aviso
							regularmente para se manterem informados sobre como protegemos seus
							dados.
						</p>
					</div>
				</div>
